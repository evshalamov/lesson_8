...
p2 = Printer('Brother', 'серый', 'лазерный')
print(p.name(), p.amount_pr, "шт")
print(p.__str__())
print(p2.__str__())


s = Scanner('Epson', 'чёрный', 'CIS')
s2 = Scanner('НР', 'белый', 'CCD')
s3 = Scanner('Kodak', 'голубой', 'CMOS')
...
x2 = Xerox('Canon', 'черный', 'есть')
x3 = Xerox('Xerox', 'серый', 'есть')
x4 = Xerox('LaserJet', 'коричневый', 'отсутствует')
